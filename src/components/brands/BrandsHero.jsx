    ...
    <section className="brands-hero">
      ...
      <div className="bh-main-image">
        <div className="container bh-hero-content">
          <div className="bh-text-box animate-on-scroll">
      ...
      <div className="bh-feature-tier">
        <div className="container bh-feature-grid">
