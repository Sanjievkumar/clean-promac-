      ...
      products: [
        {
          ...
          features: [
            'HYGIENIC — Tested in a certified lab to remove >99.99% of S. aureus, E. coli, P. aeruginosa and B. subtilis bacteria',
            'INFECTION CONTROL — With the addition of steam, dirt and grime will be removed easier than traditional cleaning methods',
            'SIMPLE — Easy to use, manoeuvre and maintain',
            'POWERFUL — Counter-rotating cylindrical brushes scrub and lift dirt, giving a more hygienic and deeper clean',
            'EFFICIENT — Wash, scrub and dry in just one pass, leaving floors ready to walk on in seconds',
            'PRODUCTIVE — Giving a quicker and more effective clean than traditional cleaning methods, saving you time and money',
            'VERSATILE — Effective on all floors with brushes available for carpets, hard floors and entrance matting',
          ],
          gallery: [
          ...
          accessories: [
            { code: '90-0728-0000', name: 'MWPRO340 Standard brush – black (Pack of 2)', type: 'Standard', image: 'https://www.truvox.com/wp-content/uploads/2023/11/90-0728-0000-284x284.png' },
            { code: '90-0731-0000', name: 'MWPRO340 Soft brush – grey (Pack of 2)', type: 'Optional', image: 'https://www.truvox.com/wp-content/uploads/2023/11/90-0731-0000-284x284.png' },
            { code: '90-0734-0000', name: 'MWPRO340 Hard brush – blue (Pack of 2)', type: 'Optional', image: 'https://www.truvox.com/wp-content/uploads/2023/11/90-0734-0000-284x284.png' },
            { code: '90-1020-0000', name: 'MWPRO340 Escalator brush – blue (Pack of 2)', type: 'Optional', image: 'https://www.truvox.com/wp-content/uploads/2023/11/90-0737-0000-284x284.png' },
            { code: '90-0723-0000', name: 'MWPRO340 Side brush – standard', type: 'Optional', image: 'https://www.truvox.com/wp-content/uploads/2023/12/90-0723-0000-284x284.png' },
            { code: '90-0845-0000', name: 'MWPRO340 Side brush – soft', type: 'Optional', image: 'https://www.truvox.com/wp-content/uploads/2023/12/90-0845-0000-284x284.png' },
            { code: '90-0846-0000', name: 'MWPRO340 Side brush – hard', type: 'Optional', image: 'https://www.truvox.com/wp-content/uploads/2023/12/90-0846-0000-284x284.png' },
            { code: '05-4781-0500', name: 'Trolley', type: 'Optional', image: 'https://www.truvox.com/wp-content/uploads/2023/11/05-4781-0000-284x284.png' },
            { code: '90-0826-0000', name: '7 litre tank', type: 'Optional', image: null },
          ],
