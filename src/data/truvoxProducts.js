    ...
    },
    {
      ...
      products: [
        ...
        },
        {
          ...
          modelCode: 'VBUII',
          image: '/assets/VBUII-website.png',
          tagline: 'A powerful, battery-powered upright vacuum that offers continuous run-time.',
          heroDescription: 'A powerful, battery-powered upright vacuum that offers continuous run-time.',
          description: 'A powerful, battery-powered upright vacuum that offers continuous run-time. Free from trip hazards and perfect for daytime cleaning with lithium-ion battery technology.',
          idealFor: ['Education', 'Facilities Management', 'Healthcare', 'Leisure', 'Retail'],
          floorTypes: ['Carpet', 'Hard Floors'],
          features: [
            { label: 'LIGHTWEIGHT', desc: 'At only 5kg, it is extremely lightweight', image: '/assets/VBUII-features-lightweight.jpg' },
            { label: 'CORDLESS', desc: 'Lithium-ion battery provides up to 50 minutes run-time', image: '/assets/VBUII-features-Cordless-2.jpg' },
            { label: 'SIMPLE', desc: 'Self-adjusting nozzle allows the vacuum to float evenly over all flooring surfaces', image: '/assets/VBUII-features-Simple.jpg' },
            { label: 'EASY', desc: 'Convenient carry handle for easy transportation', image: '/assets/VBUII-features-Easy.jpg' },
            { label: 'EFFECTIVE', desc: 'Edge cleaning feature provides improved cleaning near walls and furniture', image: '/assets/VBUII-features-Effective.jpg' },
            { label: 'FILTRATION', desc: 'HEPA media bag included', image: '/assets/VBUII-features-Filtration.jpg' },
            { label: 'EFFICIENT', desc: 'Squeegee fitted on the bottom of the vacuum to improve cleaning results on hard floors', image: '/assets/VBUII-features-Efficient.jpg' },
          ],
          gallery: [
            '/assets/VBUII-website.png',
            '/assets/VBUII-in-use.jpg',
            '/assets/VBUII-in-use-1.jpg',
            '/assets/VBUII-in-use-12.jpg',
            '/assets/VBUII-in-use-13.jpg'
          ],
          accessories: [
            { code: 'Untitled-design-45', name: 'HEPA media bag', type: 'Standard', image: '/assets/Untitled-design-45.png' },
            { code: 'C223-1800C-T', name: 'Battery (Valet Battery Upright II)', type: 'Standard', image: '/assets/C223-1800C-T.png' },
            { code: 'C223-2400', name: 'Charger (Valet Battery Upright II)', type: 'Standard', image: '/assets/C223-2400.png' },
            { code: '05-4741-0000', name: 'Pack of 10 HEPA bags', type: 'Optional', image: '/assets/05-4741-0000.png' },
          ],
          specs: {
            'Battery Voltage': 'DC 28.8 V',
            'Motor Power': '312 W',
            'Capacity': '3 Litres',
            'Brush width': '29 cm',
            'Airflow rate': '17 l/s',
            'Vacuum / water lift': '12.5 / 1274 kPa / mmwg',
            'Sound pressure level': '65 dB(A)',
            'Sound power level': '73 dB(A)',
            'Dimensions (L x W x H)': '25 x 31 x 111 cm',
            'Weight (including battery)': '5 kg',
