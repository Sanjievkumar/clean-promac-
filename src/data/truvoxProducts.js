      ...
      products: [
        {
          ...
          description: 'The Multiwash™ PRO Steam not only provides exceptional cleaning results due to its counter-rotating brushes, but with the additional steam function will sanitise floors, killing up to 99.99% of bacteria. Tested in a certified lab to remove >99.99% of S. aureus, E. coli, P. aeruginosa and B. subtilis bacteria, it delivers the deepest possible hygienic clean in a single pass — leaving floors ready to walk on in seconds.',
          ...
          features: [
            'HYGIENIC — Tested to remove >99.99% of S. aureus, E. coli, P. aeruginosa and B. subtilis bacteria',
            'INFECTION CONTROL — Steam shifts stubborn dirt and grime easier than traditional methods',
            'SIMPLE — Easy to use, manoeuvre and maintain',
            'POWERFUL — Counter-rotating cylindrical brushes scrub and lift dirt for a deeper clean',
            'EFFICIENT — Wash, scrub and dry in one pass, leaving floors ready in seconds',
            'PRODUCTIVE — Quicker and more effective than traditional cleaning methods',
            'VERSATILE — Effective on carpets, hard floors, entrance matting and more',
          ],
          accessories: [
