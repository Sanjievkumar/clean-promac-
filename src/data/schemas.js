...
export const brandsData = [
  { id: 'brand-1', name: 'KLENCO', logoUrl: '/assets/brands/klenco.png' },
  { id: 'brand-2', name: 'TRUVOX', logoUrl: '/assets/brands/truvox.png' },
  { id: 'brand-3', name: 'PROMAC', logoUrl: '/assets/brands/promac.png' }
];
